...
- data from *'X_test.txt'* file with *'X_train.txt'* file

- data from *'y_test.txt'* file with *'y_train.txt'* file
 
- data from *'subject_test.txt'* file with *'subject_train.txt'* file
